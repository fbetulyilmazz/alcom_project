namespace Alcom.Migrations
{
    ...
    public partial class version10 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        GuncellemeTarihi = c.DateTime(),
                        SilindiMi = c.Boolean(nullable: false),
                        UstKategorisi_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Kategori", t => t.UstKategorisi_Id)
                .Index(t => t.UstKategorisi_Id);
                ...
                c => new
                    {
                        ...
                        SilindiMi = c.Boolean(nullable: false),
                        Markasi_Id = c.Int(),
                        UrununOzellikleri_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Kategori", t => t.KategoriId, cascadeDelete: true)
                .ForeignKey("dbo.MarkaBilgileri", t => t.Markasi_Id)
                .ForeignKey("dbo.UrunOzellikleri", t => t.UrununOzellikleri_Id)
                .Index(t => t.KategoriId)
                .Index(t => t.Markasi_Id)
                .Index(t => t.UrununOzellikleri_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Satis", "KargoBilgileri_Id", "dbo.KargoBilgileri");
            DropForeignKey("dbo.Satis", "FaturaAdresiId", "dbo.Adres");
            DropForeignKey("dbo.Kategori", "UstKategorisi_Id", "dbo.Kategori");
            DropForeignKey("dbo.Urun", "UrununOzellikleri_Id", "dbo.UrunOzellikleri");
            DropForeignKey("dbo.Urun", "Markasi_Id", "dbo.MarkaBilgileri");
            ...
            DropIndex("dbo.Satis", new[] { "KargoBilgileri_Id" });
            DropIndex("dbo.Satis", new[] { "FaturaAdresiId" });
            DropIndex("dbo.Satis", new[] { "SepetId" });
            DropIndex("dbo.Urun", new[] { "UrununOzellikleri_Id" });
            DropIndex("dbo.Urun", new[] { "Markasi_Id" });
            DropIndex("dbo.Urun", new[] { "KategoriId" });
            DropIndex("dbo.Kategori", new[] { "UstKategorisi_Id" });
